...
function bootstrap() {
    return __awaiter(this, void 0, void 0, function () {
        var app, configService, apiPrefix, origins, swaggerConfig, document_1, port;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.sent();
                    console.log("\n\uD83D\uDE80 Server running on: http://localhost:".concat(port, "/").concat(apiPrefix));
                    console.log("\uD83D\uDCC4 Swagger docs:      http://localhost:".concat(port, "/").concat(apiPrefix, "/docs\n"));
                    return [2 /*return*/];
            }
        });
    });
